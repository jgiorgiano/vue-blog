    ...
    <div class="bg-gray-900 text-white flex flex-col align-content-between">
            ...
            <div class="flex flex-1 justify-around my-2">
                <div class="flex justify-center my-2">
                    <div>
                        ...
                        <div class="flex my-4">
                            <a class="mx-1 text-indigo-600 hover:text-indigo-800" href="https://twitter.com/jhonathanmg44" target="_blank">
                            ...
                            <a class="mx-1 text-indigo-600 hover:text-indigo-800" href="https://www.instagram.com/jhonathan_giorgiano" target="_blank">
        ...
        <div class="text-center mt-auto border-t border-indigo-800">
            <a class="text-indigo-800 hover:text-indigo-600 transition ease-in duration-75"
               href="http://jhonathan.co.uk">JMG</a>
        </div>
    </div>
</template>
