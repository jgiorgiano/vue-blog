...
<!--                        </div>-->
                        <div class="leading-none mb-8">
                            ...
                            <small class="uppercase">Full-Stack Web Developer</small>
                        </div>
                    </header>
                    ...
                    <section class="mb-8">
                        <div class="col-break-avoid">
                            ...
                            <section class="mb-2 col-break-avoid ml-4">
                                <header>
<!--                                    <h3 class="text-lg text-gray-800 font-semibold leading-snug">Full-Stack Web-->
<!--                                        Developer</h3>-->
                                </header>
                    ...
                    <section class="mt-8">
                        <div class="col-break-avoid">
                            ...
                            <section class="mb-4 col-break-avoid">
                                <header>
                                    <h3 class="text-lg text-gray-800 font-semibold leading-snug">
                                        Bachelor in Business Administration
                                    </h3>
                                    <p class="text-gray-700 leading-normal mb-2">
                                        2008 – 2012 | University Centro Herminio Ometto - FHO
                                    </p>
                                    <p class="ml-4">
                    ...
                    <section class="mt-4 py-2 px-4 bg-gray-100 col-break-avoid">
                        ...
                        <h2 class="text-2xl text-gray-800 font-extrabold print:font-normal tracking-widest">
                            Key skills
                        </h2>
...
<!--                                    <li class="mt-1 pl-6 text-gray-700 leading-normal">-->
<!--                                        <a href="https://github.com/fabriciozeferino/billboard" target="_blank"-->
<!--                                           class="group">-->
